...
def test_find(setup_browser):
    ...
    """
    Поиск на странице с ошибкой в слове
    :return:
    """
    with allure.step("Поиск на странице"):
        browser.open("https://www.labirint.ru/")
...
def test_click_office(setup_browser):
    browser = setup_browser
    """
    Выбор офисных принадлежностей на главной странице
    :param browser_desktop: параметры браузера
    :return:
    """
    browser.open("/")
...
def test_id_books(setup_browser):
    browser = setup_browser
    """
    Добавление товаров по ID в корзину и оформление заказа
    :param browser_desktop:
    :return:
    """
    browser.open("/")
